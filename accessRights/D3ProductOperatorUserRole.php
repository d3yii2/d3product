...
namespace d3yii2\d3product\accessRights;
...
class D3ProductOperatorUserRole implements UserRoleInterface
{

    public const NAME = 'D3ProductOperator';
    ...
    */
    ...
    {
        return Yii::t('d3product', 'Operator');
